...
<img src="docs/screenshots/m-dashboard.png" alt="Дашборд на мобильном" width="44%" align="left" /> <img src="docs/screenshots/m-pipeline-detail.png" alt="Детали пайплайна на мобильном" width="44%" align="right" /> <img src="docs/screenshots/m-projects.png" alt="Проекты на мобильном" width="44%" align="left" /> <img src="docs/screenshots/m-pull-request.png" alt="Pull request на мобильном" width="44%" align="right" /> <img src="docs/screenshots/m-repo-code.png" alt="Код репозитория на мобильном" width="44%" align="left" /> <img src="docs/screenshots/m-runners.png" alt="Раннеры на мобильном" width="44%" align="right" />
