...
- Current: `.github/workflows/ci.yml` выполняет frozen lockfile install, Rust fmt/clippy/tests, frontend lint/test/build, docs checks, secret scan, `cargo audit`, `pnpm audit --audit-level high` и SBOM drift gate.
