...
| Documentation drift | `scripts/verify_docs.py --all` сверяет route inventory, OpenAPI paths, screenshot manifest, canonical names, current-state route count и readiness migration-version examples с текущими источниками. |
