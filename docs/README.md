...
- [IMPLEMENTATION_CONTRACTS](IMPLEMENTATION_CONTRACTS.md), [MIGRATION_EXECUTION_SPEC](MIGRATION_EXECUTION_SPEC.md), [AUTH_IMPLEMENTATION_SPEC](AUTH_IMPLEMENTATION_SPEC.md), [EXECUTION_AUTOMATION_IMPLEMENTATION_SPEC](EXECUTION_AUTOMATION_IMPLEMENTATION_SPEC.md) — executable specs для реализации approved target capability.
