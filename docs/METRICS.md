...
|---|---|---|
| HTTP requests: rate / errors / latency p50-p99 (per route) | axum middleware | Target (axum-prometheus, `TECH_CHOICES.md`); local E2E has synthetic API read p95 smoke in `frontend/e2e/performance.spec.ts` |
