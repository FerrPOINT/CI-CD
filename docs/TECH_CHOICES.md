...
| Cron parser / [`tokio-cron-scheduler`](https://docs.rs/tokio-cron-scheduler/latest/tokio_cron_scheduler/) | Scheduler semantics | Phase automation hardening | Можно использовать для parsing/next-fire, но dedup, claim и missed-fire recovery остаются в PostgreSQL. |
