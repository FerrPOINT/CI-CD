...
| Execution | Queue, attempts, dispatch, runner protocol, sandbox | Частично: durable `job_queue`, attempts/leases, embedded runner + external runner protocol/`forge-runner` shell MVP; sandbox target | Да |
