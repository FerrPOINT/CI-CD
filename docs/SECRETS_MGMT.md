...
> **Статус:** MVP реализован (зашифрованное хранение + API + UI). Не реализовано: инжекция в runner-окружение, маскирование в логах, ротация ключа. См. `docs/ROADMAP.md` Phase 7.
