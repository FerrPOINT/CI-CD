...
export interface paths {
    ...
    "/api/v1/runner/leases/{lease_id}/artifact-sessions/{session_id}/abort": {
        ...
        get?: never;
        put?: never;
        post: operations["abort_artifact_upload_session"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/runner/leases/{lease_id}/artifact-sessions/{session_id}/chunks": {
        ...
        get?: never;
        put?: never;
        post: operations["append_artifact_upload_chunk"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/runner/leases/{lease_id}/artifact-sessions/{session_id}/complete": {
        ...
        get?: never;
        put?: never;
        post: operations["complete_artifact_upload_session"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/runner/leases/{lease_id}/artifact-sessions:begin": {
        ...
        get?: never;
        put?: never;
        post: operations["begin_artifact_upload_session"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        ArtifactSessionCompleteRequest: {
        ...
        ArtifactSessionStatusResponse: {
            /** Format: int64 */
            highestChunk: number;
            /** @description Resume hint: sorted chunk indices already persisted. */
        ...
        JobLogPage: {
            /** @description True when a `before` window has older rows beyond this page. */
            ...
            /**
             * Format: int64
             * @description Total matching rows for the current filter (K4.2 windowing).
             */
            total: number;
        };
        /** @enum {string} */
        ...
        Project: {
            ...
            /**
             * Format: int32
             * @description K4.3 dispatch cap: null = unlimited.
             */
        ...
        UpdateProject: {
            ...
            /**
             * Format: int32
             * @description K4.3 dispatch fairness: max concurrently active-leased jobs for this
...
export interface operations {
    ...
    list_attempt_logs_page: {
        parameters: {
            query?: {
                ...
                after?: number | null;
                /**
                 * @description Tail-window cursor: return the newest rows with sequence less than
    ...
    abort_artifact_upload_session: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ArtifactSessionCompleteRequest"];
            };
        };
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ArtifactSessionStatusResponse"];
                };
            };
            401: {
                headers: {
    ...
    append_artifact_upload_chunk: {
        ...
        responses: {
            ...
            /** @description chunk index regression */
            409: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    complete_artifact_upload_session: {
        ...
        responses: {
            ...
            /** @description received bytes != declared size */
            409: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    begin_artifact_upload_session: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ArtifactSessionBeginRequest"];
            };
        };
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ArtifactSessionBeginResponse"];
                };
            };
            400: {
                headers: {
