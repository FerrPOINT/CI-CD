...
const routeCases = [
  ...
  { entry: `/projects/${projectId}/webhooks`, marker: 'https://hooks.example.com/ci' },
  { entry: `/projects/${projectId}/webhooks?view=deliveries`, marker: 'receiver returned 500' },
  { entry: `/projects/${projectId}/webhooks?view=notifications`, marker: 'Pipeline failed' },
