...
- Evidence tooling: `shoot-evidence.mjs` корректно передаёт тему в browser context, frontend CI проверяет syntax evidence scripts, PR template синхронизирован с текущими CI gates.
