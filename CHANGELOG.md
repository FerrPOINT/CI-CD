...
- Убрана недоступная в Central Auth форма участников проекта; старые ссылки
  перенаправляются в проекты, а руководство и визуальные материалы показывают
  актуальный переход к управлению пользователями в Admin Panel.
