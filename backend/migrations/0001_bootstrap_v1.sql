-- 0001_bootstrap_v1: baseline schema extracted verbatim from the historical
-- startup bootstrap (backend/src/store.rs migrate()). Do not edit: this file
-- reproduces the legacy DDL exactly so existing databases adopt cleanly
-- (ADR-0008, MIGRATION_CONTRACT §adopt-legacy).
